...
class HutanAdat
{
    ...
    public function getAll()
    {
        $sql = "SELECT
                ...
                ha.luas_ha,
                ST_AsText(ha.geom_area) AS geom_area,
                ha.keterangan,
                ha.is_active,
    ...
    public function create($data)
    {
        ...
        $sql = "INSERT INTO t_hutan_adat
            (kode_hutan_adat,nama_hutan_adat,id_masyarakat_hukum_adat,id_desa,nomor_sk,tanggal_sk,id_status_kawasan,luas_ha,geom_area,keterangan,is_active,created_by)
            VALUES
            (:kode_hutan_adat,:nama_hutan_adat,:id_masyarakat_hukum_adat,:id_desa,:nomor_sk,:tanggal_sk,:id_status_kawasan,:luas_ha,ST_GeomFromText(:geom_area, 4326),:keterangan,:is_active,:created_by)";
