...
require_once '../../app/controllers/LegalitasLahanController.php';
...
$controller = new LegalitasLahanController($pdo);
$legalitasLahans = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Legalitas Lahan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Legalitas Lahan</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Legalitas Lahan</h3>
                                        ...
                                        <tbody>
                                            <?php foreach ($legalitasLahans as $legalitasLahan): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($legalitasLahan['urutan']) ?></td>
                                                    <td><?= $legalitasLahan['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $legalitasLahan['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($legalitasLahan['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($legalitasLahan['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($legalitasLahan['deskripsi']) ?>"
                                                                data-urutan="<?= $legalitasLahan['urutan'] ?>"
                                                                data-status="<?= $legalitasLahan['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Legalitas Lahan</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama legalitas lahan">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Legalitas Lahan</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Legalitas Lahan"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Legalitas Lahan"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Legalitas Lahan"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Legalitas Lahan berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Legalitas Lahan berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Legalitas Lahan berhasil dihapus", "deleted");
        }
    </script>
</body>
