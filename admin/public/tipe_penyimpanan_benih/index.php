...
require_once '../../app/controllers/TipePenyimpananBenihController.php';
...
$controller = new TipePenyimpananBenihController($pdo);
$tipePenyimpananBenihs = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Tipe Penyimpanan Benih</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Tipe Penyimpanan Benih</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Tipe Penyimpanan Benih</h3>
                                    <button class="col-3 btn btn-block btn-success" data-toggle="modal"
                                        data-target="#modalTambah">
                                        Tambah Tipe Penyimpanan Benih
                                    </button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Tipe Penyimpanan Benih</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($tipePenyimpananBenihs as $tipePenyimpananBenih): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($tipePenyimpananBenih['kode']) ?></td>
                                                    <td><?= htmlspecialchars($tipePenyimpananBenih['nama']) ?></td>
                                                    <td><?= htmlspecialchars($tipePenyimpananBenih['deskripsi']) ?></td>
                                                    <td><?= htmlspecialchars($tipePenyimpananBenih['urutan']) ?></td>
                                                    <td><?= $tipePenyimpananBenih['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $tipePenyimpananBenih['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($tipePenyimpananBenih['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($tipePenyimpananBenih['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($tipePenyimpananBenih['deskripsi']) ?>"
                                                                data-urutan="<?= $tipePenyimpananBenih['urutan'] ?>"
                                                                data-status="<?= $tipePenyimpananBenih['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Tipe Penyimpanan Benih</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Tipe Penyimpanan Benih<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new TipePenyimpananBenih($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode tipe penyimpanan benih">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Tipe Penyimpanan Benih<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama tipe penyimpanan benih">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Tipe Penyimpanan Benih</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Tipe Penyimpanan Benih"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Tipe Penyimpanan Benih"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Tipe Penyimpanan Benih"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Tipe Penyimpanan Benih berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Tipe Penyimpanan Benih berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Tipe Penyimpanan Benih berhasil dihapus", "deleted");
        }
    </script>
</body>
