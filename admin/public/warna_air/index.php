...
require_once '../../app/controllers/WarnaAirController.php';
...
$controller = new WarnaAirController($pdo);
$warnaAirs = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Warna Air</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Warna Air</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Warna Air</h3>
                                        ...
                                        <tbody>
                                            <?php foreach ($warnaAirs as $warnaAir): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($warnaAir['urutan']) ?></td>
                                                    <td><?= $warnaAir['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $warnaAir['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($warnaAir['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($warnaAir['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($warnaAir['deskripsi']) ?>"
                                                                data-urutan="<?= $warnaAir['urutan'] ?>"
                                                                data-status="<?= $warnaAir['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Warna Air</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama warna air">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Warna Air</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Warna Air"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Warna Air"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Warna Air"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Warna Air berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Warna Air berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Warna Air berhasil dihapus", "deleted");
        }
    </script>
</body>
