...
require_once '../../app/controllers/KecepatanAliranController.php';
...
$controller = new KecepatanAliranController($pdo);
$kecepatanAlirans = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Kecepatan Aliran</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Kecepatan Aliran</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Kecepatan Aliran</h3>
                                    <button class="col-3 btn btn-block btn-success" data-toggle="modal"
                                        data-target="#modalTambah">
                                        Tambah Kecepatan Aliran
                                    </button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Kecepatan Aliran</th>
                                                <th>Nama Kecepatan Aliran</th>
                                                <th>Deskripsi</th>
                                                <th>Urutan</th>
                                                <th>Status Aktif</th>
                                                <th>Aksi</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kecepatanAlirans as $kecepatanAliran): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($kecepatanAliran['kode']) ?></td>
                                                    <td><?= htmlspecialchars($kecepatanAliran['nama']) ?></td>
                                                    <td><?= htmlspecialchars($kecepatanAliran['deskripsi']) ?></td>
                                                    <td><?= htmlspecialchars($kecepatanAliran['urutan']) ?></td>
                                                    <td><?= $kecepatanAliran['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $kecepatanAliran['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($kecepatanAliran['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($kecepatanAliran['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($kecepatanAliran['deskripsi']) ?>"
                                                                data-urutan="<?= $kecepatanAliran['urutan'] ?>"
                                                                data-status="<?= $kecepatanAliran['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Kecepatan Aliran</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Kecepatan Aliran<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new KecepatanAliran($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode kecepatan aliran">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Kecepatan Aliran<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama kecepatan aliran">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Kecepatan Aliran</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Kecepatan Aliran"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Kecepatan Aliran"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Kecepatan Aliran"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Kecepatan Aliran berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Kecepatan Aliran berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Kecepatan Aliran berhasil dihapus", "deleted");
        }
    </script>
</body>
