...
require_once '../../app/controllers/FiturTambahanController.php';
...
$controller = new FiturTambahanController($pdo);
$fiturTambahans = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Fitur Tambahan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Fitur Tambahan</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Fitur Tambahan</h3>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Fitur Tambahan</th>
                                                <th>Nama Fitur Tambahan</th>
                                                <th>Deskripsi</th>
                                                <th>Urutan</th>
                                                <th>Status Aktif</th>
                                                <th>Aksi</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($fiturTambahans as $fiturTambahan): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($fiturTambahan['kode']) ?></td>
                                                    <td><?= htmlspecialchars($fiturTambahan['nama']) ?></td>
                                                    <td><?= htmlspecialchars($fiturTambahan['deskripsi']) ?></td>
                                                    <td><?= htmlspecialchars($fiturTambahan['urutan']) ?></td>
                                                    <td><?= $fiturTambahan['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $fiturTambahan['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($fiturTambahan['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($fiturTambahan['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($fiturTambahan['deskripsi']) ?>"
                                                                data-urutan="<?= $fiturTambahan['urutan'] ?>"
                                                                data-status="<?= $fiturTambahan['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Fitur Tambahan</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Fitur Tambahan<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new FiturTambahan($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode fitur tambahan">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Fitur Tambahan<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama fitur tambahan">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Fitur Tambahan</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Fitur Tambahan"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Fitur Tambahan"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Fitur Tambahan"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Fitur Tambahan berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Fitur Tambahan berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Fitur Tambahan berhasil dihapus", "deleted");
        }
    </script>
</body>
