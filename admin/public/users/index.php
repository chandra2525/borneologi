...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="id_role">Role<code>*</code></label>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="formEdit" method="POST" action="update.php">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="edit_id_role">Role<code>*</code></label>
                                    <select name="id_role" class="form-control" id="edit_id_role">
                                        <option value="">-- Pilih Role --</option>
                                        <?php foreach ($roles as $r): ?>
                                            <option value="<?= $r['id'] ?>">
                                                <?= htmlspecialchars($r['nama']) ?>
    ...
    <script>
        $(function () {
            ...
            initValidationTambah("#formTambah");
            initValidationEdit("#formEdit");
        });
    </script>
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Pengguna berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Pengguna berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Pengguna berhasil dihapus", "deleted");
        }
    </script>
</body>
