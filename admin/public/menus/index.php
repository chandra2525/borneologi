...
<body class="hold-transition sidebar-mini">
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Menu"
                        },
                        nama: {
                        ...
                        is_active: {
                            required: "Silahkan pilih Status Menu"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Menu berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Menu berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Menu berhasil dihapus", "deleted");
        }
    </script>
</body>
