...
require_once '../../app/controllers/StatusKawasanController.php';
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Status Kawasan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Status Kawasan</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Status Kawasan</th>
                                                <th>Nama Status Kawasan</th>
                                                <th>Deskripsi</th>
                                                <th>Urutan</th>
                                                <th>Status Aktif</th>
                                                <th>Aksi</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($statusKawasans as $statusKawasan): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($statusKawasan['kode']) ?></td>
                                                    <td><?= htmlspecialchars($statusKawasan['nama']) ?></td>
                                                    <td><?= htmlspecialchars($statusKawasan['deskripsi']) ?></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Status Kawasan</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Status Kawasan<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new StatusKawasan($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode status kawasan">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Status Kawasan<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama status kawasan">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Status Kawasan</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Status Kawasan"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Status Kawasan"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Status Kawasan"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Status Kawasan berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Status Kawasan berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Status Kawasan berhasil dihapus", "deleted");
        }
    </script>
</body>
