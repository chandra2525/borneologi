...
require_once '../../app/controllers/PenggunaanPertanianController.php';
...
$controller = new PenggunaanPertanianController($pdo);
$penggunaanPertanians = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Penggunaan Pertanian</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Penggunaan Pertanian</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Penggunaan Pertanian</h3>
                                    <button class="col-3 btn btn-block btn-success" data-toggle="modal"
                                        data-target="#modalTambah">
                                        Tambah Penggunaan Pertanian
                                    </button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php foreach ($penggunaanPertanians as $penggunaanPertanian): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($penggunaanPertanian['urutan']) ?></td>
                                                    <td><?= $penggunaanPertanian['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $penggunaanPertanian['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($penggunaanPertanian['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($penggunaanPertanian['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($penggunaanPertanian['deskripsi']) ?>"
                                                                data-urutan="<?= $penggunaanPertanian['urutan'] ?>"
                                                                data-status="<?= $penggunaanPertanian['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Penggunaan Pertanian</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama penggunaan pertanian">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Penggunaan Pertanian</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Penggunaan Pertanian"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Penggunaan Pertanian"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Penggunaan Pertanian"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Penggunaan Pertanian berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Penggunaan Pertanian berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Penggunaan Pertanian berhasil dihapus", "deleted");
        }
    </script>
</body>
