...
require_once '../../app/controllers/ProgressStatusMonitoringController.php';
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <?php
        $menu = "progress_status_monitoring";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Progress Status Monitoring</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Progress Status Monitoring</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Progress Status Monitoring</th>
                                                <th>Nama Progress Status Monitoring</th>
                                                <th>Deskripsi</th>
                                                <th>Urutan</th>
                                                <th>Status Aktif</th>
                                                <th>Aksi</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($progressStatusMonitorings as $progressStatusMonitoring): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($progressStatusMonitoring['kode']) ?></td>
                                                    <td><?= htmlspecialchars($progressStatusMonitoring['nama']) ?></td>
                                                    <td><?= htmlspecialchars($progressStatusMonitoring['deskripsi']) ?></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Progress Status Monitoring</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Progress Status Monitoring<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new ProgressStatusMonitoring($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode progress status monitoring">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Progress Status Monitoring<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama progress status monitoring">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Progress Status Monitoring</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Progress Status Monitoring"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Progress Status Monitoring"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Progress Status Monitoring"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Progress Status Monitoring berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Progress Status Monitoring berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Progress Status Monitoring berhasil dihapus", "deleted");
        }
    </script>
</body>
