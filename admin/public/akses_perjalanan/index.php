...
require_once '../../app/controllers/AksesPerjalananController.php';
...
$controller = new AksesPerjalananController($pdo);
$aksesPerjalanans = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Akses Perjalanan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Akses Perjalanan</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Akses Perjalanan</h3>
                                    <button class="col-3 btn btn-block btn-success" data-toggle="modal"
                                        data-target="#modalTambah">
                                        Tambah Akses Perjalanan
                                    </button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Akses Perjalanan</th>
                                                <th>Nama Akses Perjalanan</th>
                                                <th>Deskripsi</th>
                                                <th>Urutan</th>
                                                <th>Status Aktif</th>
                                                <th>Aksi</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($aksesPerjalanans as $aksesPerjalanan): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($aksesPerjalanan['kode']) ?></td>
                                                    <td><?= htmlspecialchars($aksesPerjalanan['nama']) ?></td>
                                                    <td><?= htmlspecialchars($aksesPerjalanan['deskripsi']) ?></td>
                                                    <td><?= htmlspecialchars($aksesPerjalanan['urutan']) ?></td>
                                                    <td><?= $aksesPerjalanan['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $aksesPerjalanan['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($aksesPerjalanan['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($aksesPerjalanan['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($aksesPerjalanan['deskripsi']) ?>"
                                                                data-urutan="<?= $aksesPerjalanan['urutan'] ?>"
                                                                data-status="<?= $aksesPerjalanan['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Akses Perjalanan</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Akses Perjalanan<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new AksesPerjalanan($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode akses perjalanan">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Akses Perjalanan<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama akses perjalanan">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Akses Perjalanan</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Akses Perjalanan"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Akses Perjalanan"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Akses Perjalanan"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Akses Perjalanan berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Akses Perjalanan berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Akses Perjalanan berhasil dihapus", "deleted");
        }
    </script>
</body>
