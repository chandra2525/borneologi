...
require_once '../../app/controllers/FungsiPohonController.php';
...
$controller = new FungsiPohonController($pdo);
$fungsiPohons = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Fungsi Pohon</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Fungsi Pohon</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Fungsi Pohon</h3>
                                        ...
                                        <tbody>
                                            <?php foreach ($fungsiPohons as $fungsiPohon): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($fungsiPohon['urutan']) ?></td>
                                                    <td><?= $fungsiPohon['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $fungsiPohon['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($fungsiPohon['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($fungsiPohon['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($fungsiPohon['deskripsi']) ?>"
                                                                data-urutan="<?= $fungsiPohon['urutan'] ?>"
                                                                data-status="<?= $fungsiPohon['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Fungsi Pohon</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama fungsi pohon">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Fungsi Pohon</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Fungsi Pohon"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Fungsi Pohon"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Fungsi Pohon"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Fungsi Pohon berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Fungsi Pohon berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Fungsi Pohon berhasil dihapus", "deleted");
        }
    </script>
</body>
