...
require_once '../../app/controllers/JenisPohonController.php';
...
$controller = new JenisPohonController($pdo);
$jenisPohons = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Jenis Pohon</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Jenis Pohon</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Jenis Pohon</h3>
                                        ...
                                        <tbody>
                                            <?php foreach ($jenisPohons as $jenisPohon): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($jenisPohon['deskripsi']) ?></td>
                                                    <td><?= htmlspecialchars($jenisPohon['urutan']) ?></td>
                                                    <td><?= $jenisPohon['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $jenisPohon['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($jenisPohon['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($jenisPohon['nama']) ?>"
                                                                data-nama_latin="<?= htmlspecialchars($jenisPohon['nama_latin']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($jenisPohon['deskripsi']) ?>"
                                                                data-urutan="<?= $jenisPohon['urutan'] ?>"
                                                                data-status="<?= $jenisPohon['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Jenis Pohon</h4>
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Jenis Pohon</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Jenis Pohon"
                        },
                        nama: {
                        ...
                        is_active: {
                            required: "Silahkan pilih Status Jenis Pohon"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Jenis Pohon berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Jenis Pohon berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Jenis Pohon berhasil dihapus", "deleted");
        }
    </script>
</body>
