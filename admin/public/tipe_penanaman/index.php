...
require_once '../../app/controllers/TipePenanamanController.php';
...
$controller = new TipePenanamanController($pdo);
$tipePenanamans = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Tipe Penanaman</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Tipe Penanaman</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Tipe Penanaman</h3>
                                    <button class="col-3 btn btn-block btn-success" data-toggle="modal"
                                        data-target="#modalTambah">
                                        Tambah Tipe Penanaman
                                    </button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php foreach ($tipePenanamans as $tipePenanaman): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($tipePenanaman['urutan']) ?></td>
                                                    <td><?= $tipePenanaman['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $tipePenanaman['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($tipePenanaman['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($tipePenanaman['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($tipePenanaman['deskripsi']) ?>"
                                                                data-urutan="<?= $tipePenanaman['urutan'] ?>"
                                                                data-status="<?= $tipePenanaman['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Tipe Penanaman</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama tipe penanaman">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Tipe Penanaman</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Tipe Penanaman"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Tipe Penanaman"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Tipe Penanaman"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Tipe Penanaman berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Tipe Penanaman berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Tipe Penanaman berhasil dihapus", "deleted");
        }
    </script>
</body>
