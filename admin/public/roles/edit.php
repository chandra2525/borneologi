                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="quickForm" method="POST" action="update.php">
                                    <?= csrfField() ?>
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="<?= e_attr($role['id']) ?>">
                                        <div class="form-group">
                                            <label for="kode">Kode Role<code>*</code></label>
                                            <input type="text" name="kode" value="<?= e_attr($role['kode']) ?>"
                                                class="form-control" id="kode" placeholder="Masukkan kode role">
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Nama Role<code>*</code></label>
                                            <input type="text" name="nama" value="<?= e_attr($role['nama']) ?>"
                                                class="form-control" id="nama" placeholder="Masukkan nama role">
                                        </div>
                                        <div class="form-group">
                                            <label for="deskripsi">Deskripsi</label>
                                            <textarea type="text" name="deskripsi" class="form-control" id="deskripsi"
                                                placeholder="Masukkan deskripsi"><?= e($role['deskripsi']) ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="urutan">Urutan<code>*</code></label>
                                            <input type="number" name="urutan" value="<?= e_attr($role['urutan']) ?>"
                                                class="form-control" id="urutan" placeholder="Masukkan urutan">
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" id="radioAktif"
                                                            name="is_active" value="1" <?= ($role['is_active'] == 1) ? 'checked' : '' ?>>
                                                        <label for="radioAktif" class="custom-control-label">
                                                            Aktif
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio"
                                                            id="radioNonaktif" name="is_active" value="0"
                                                            <?= ($role['is_active'] == 0) ? 'checked' : '' ?>>

                                                        <label for="radioNonaktif" class="custom-control-label">
                                                            Nonaktif
                                                        </label>
                                                    </div>
                                                </div>
