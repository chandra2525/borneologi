...
require_once '../../app/controllers/JenisPalungController.php';
...
$controller = new JenisPalungController($pdo);
$jenisPalungs = $controller->index();
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Jenis Palung</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                                <li class="breadcrumb-item active">Data Jenis Palung</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Jenis Palung</h3>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Kode Jenis Palung</th>
                                                <th>Nama Jenis Palung</th>
                                                <th>Deskripsi</th>
                                                <th>Urutan</th>
                                                <th>Status Aktif</th>
                                                <th>Aksi</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($jenisPalungs as $jenisPalung): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($jenisPalung['kode']) ?></td>
                                                    <td><?= htmlspecialchars($jenisPalung['nama']) ?></td>
                                                    <td><?= htmlspecialchars($jenisPalung['deskripsi']) ?></td>
                                                    <td><?= htmlspecialchars($jenisPalung['urutan']) ?></td>
                                                    <td><?= $jenisPalung['is_active'] ? 'Aktif' : 'Nonaktif' ?></td>
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $jenisPalung['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($jenisPalung['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($jenisPalung['nama']) ?>"
                                                                data-deskripsi="<?= htmlspecialchars($jenisPalung['deskripsi']) ?>"
                                                                data-urutan="<?= $jenisPalung['urutan'] ?>"
                                                                data-status="<?= $jenisPalung['is_active'] ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Jenis Palung</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Jenis Palung<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new JenisPalung($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode jenis palung">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Jenis Palung<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama jenis palung">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Jenis Palung</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Jenis Palung"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Jenis Palung"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Jenis Palung"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Jenis Palung berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Jenis Palung berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Jenis Palung berhasil dihapus", "deleted");
        }
    </script>
</body>
