...
require_once '../../app/controllers/LanskapController.php';
...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Data Lanskap</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($lanskaps as $lanskap): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($lanskap['kode']) ?></td>
                                                    <td><?= htmlspecialchars($lanskap['nama']) ?></td>
                                                    <td><?= htmlspecialchars($lanskap['deskripsi']) ?></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Lanskap</h4>
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Lanskap<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        value="<?= (new Lanskap($pdo))->generateKode() ?>"
                                        placeholder="Masukkan kode lanskap">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Lanskap<code>*</code></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama lanskap">
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalEdit">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Lanskap</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Lanskap"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Lanskap"
                        },
                        urutan: {
                            required: "Silahkan masukkan Urutan"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Lanskap"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Lanskap berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Lanskap berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Lanskap berhasil dihapus", "deleted");
        }
    </script>
</body>
