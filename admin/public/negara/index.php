...
require_once '../../app/controllers/NegaraController.php';
...
$controller = new NegaraController($pdo);
$negaras = $controller->index();
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header row">
                                    <h3 class="card-title col-9">Berikut adalah list dari Data Negara</h3>
                                                    ...
                                                    <td class="row">
                                                        <div class="col">
                                                            <button class="btn btn-block btn-info btn-edit"
                                                                data-id="<?= $negara['id'] ?>"
                                                                data-kode="<?= htmlspecialchars($negara['kode']) ?>"
                                                                data-nama="<?= htmlspecialchars($negara['nama']) ?>"
                                                                data-status="<?= $negara['is_active'] ?>"
                        ...
                        <form id="formTambah" method="POST" action="store.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Negara<code>*</code></label>
                                    <input type="text" name="kode" class="form-control" id="kode"
                                        placeholder="Masukkan kode negara" maxlength="3">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Negara<code>*</code></label>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="formEdit" method="POST" action="update.php">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="kode">Kode Negara<code>*</code></label>
                                    <input type="text" name="kode" id="edit_kode" class="form-control" maxlength="3">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Negara<code>*</code></label>
        ...
        $(function () {
            function initValidation(formId) {
                $(formId).validate({
                    ...
                    messages: {
                        kode: {
                            required: "Silahkan masukkan Kode Negara"
                        },
                        nama: {
                            required: "Silahkan masukkan Nama Negara"
                        },
                        is_active: {
                            required: "Silahkan pilih Status Negara"
                        }
                    },
                    errorElement: 'span',
    ...
    <script>
        ...
        if (success === "created") {
            showToast("Data Negara berhasil ditambahkan", "created");
        }
        if (success === "updated") {
            showToast("Data Negara berhasil diperbarui", "updated");
        }
        if (success === "deleted") {
            showToast("Data Negara berhasil dihapus", "deleted");
        }
    </script>
</body>
